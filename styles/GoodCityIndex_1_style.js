...
var style_GoodCityIndex_1 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    var value = feature.get("GCI");
    var labelText = "";
    size = 0;
    ...
    if (value >= 20.000000 && value <= 47.200000) {
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 47.200000 && value <= 65.000000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 65.000000 && value <= 74.800000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 74.800000 && value <= 89.000000) {
            style = [ new ol.style.Style({
